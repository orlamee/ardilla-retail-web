          ...
          >
            Continue
						...
						>
							...
							<div className="mx-auto flex justify-center">
								<div className="flex justify-start flex-wrap max-w-[408px]  gap-6 mt-14">
									...
									<button
										className={`border-[1px]  text-[12px] font-medium rounded-full px-4 hover:bg-[#F2FCF2] hover:border-[#A5DBA5] hover:text-[#23A323] duration-300 ${
											selectedDom === "Last Day"
												? "bg-[#F2FCF2] border-[#A5DBA5] text-[#23A323]"
												: "border-[#E5E7EB] bg-white text-[#9CA3AF]"
										}`}
				...
				<div className="flex justify-center">
					{selectedF === "Daily" ? (
						<button
							className=" cursor-pointer text-[14px] w-full font-[500] bg-primary text-white p-5 rounded-[8px]  disabled:bg-primary/60"
							onClick={() => {
						...
						<button
							className="mt-8 cursor-pointer text-[14px] w-full font-[500] bg-primary text-white p-5 rounded-[8px]  disabled:bg-primary/60"
							onClick={() => {
								// setProgress((prev) => prev + 14);
								// handleContinue();
								next();
						...
						<button
							className="p-5 mt-10  cursor-pointer bg-primary text-white w-full  rounded-[8px] text-[14px] disabled:bg-primary/60"
							onClick={() => {
								// setProgress((prev) => prev + 14);
								// handleContinue();
								// setModal("estimate");
