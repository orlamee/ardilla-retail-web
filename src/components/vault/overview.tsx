...
import dib from "../../assets/vault (3).png";
import Image from "next/image";
import refresh from "../../assets/refresh.png";
import kodhex from "../../assets/kodxxx.svg";
import insufficientKodhex from "../../assets/insufficient kodex.svg";
import {
	Ban,
	CheckCircle2,
	ChevronDown,
...
import savings from "../../assets/savingsss.svg";
		...
		<Modal>
			<AnimatePresence>
				...
				>
					...
					<p className="text-center text-[12px] font-[500] text-gray400 max-w-[329px] mx-auto mb-5">
						Your savings plan has been created and successfully funded.{" "}
						<br /> You can view the details on your DIB dashboard.
					</p>
	...
	return (
		<div className="mt-10">
			...
			<div className="max-w-[450px] mx-auto mt-8">
				...
				<div
					className="flex justify-between items-center p-4 border-[1px] border-[#F3F4F6] rounded-[4px] mb-4"
					onClick={() => setModal("overview")}
				>
					<div className="flex items-center ">
				...
				<div className="flex justify-between items-center p-4 border-[1px] border-[#F3F4F6] rounded-[4px] mb-8">
					<div className="flex items-center ">
				...
				<button
					className="bg-primary text-white w-full text-[14px] font-[500] p-5 rounded-[8px]"
					onClick={() => setModal("overview")}
				>
					Pay
				</button>
