                      ...
                      <div className="border border-[#F3F4F6] rounded-[8px] px-3 py-4 mx-2">
                        <div className="flex flex-row mb-3">
                          <div className="flex-none">
                            {/* <img src={withdraw} alt="with" className="w-[50px]" /> */}
                          </div>
          ...
          {/* <div className="grid lg:grid-cols-2 grid-cols-1 gap-10">
            <Link href={"/dashboard/dib"}>
              <div className="border-[#000] border rounded-[18px] p-9 shadow-[6px_6px_black]">
                ...
                <h6 className="text-[#000000] text-[16px] leading-[24px] font-[400]">
                  Your money saved for whenever you need it, take a 15% Dividends
                  when you fulfil your savings goals
                </h6>
              </div>
            </Link>
            <div className="border-[#000] border rounded-[18px] p-9 shadow-[6px_6px_black]">
            ...
            <div className="border-[#000] border rounded-[18px] p-9 shadow-[6px_6px_black]">
              <div className="flex items-center mb-4">
                ...
                <div className="flex-none">
                  <button className="bg-[#A855F7] rounded-[7px] p-3 font-[500] text-[13px] leading-[18px]">
                    Create Dreams Plan
                  </button>
                </div>
              </div>
            ...
            <div className="border-[#000] border rounded-[18px] p-9 shadow-[6px_6px_black]">
              <div className="flex items-center mb-4">
                ...
                <div className="flex-none">
                  <button className="bg-[#FFBD00] rounded-[7px] p-3 font-[500] text-[13px] leading-[18px]">
                    Create Shopwise
                  </button>
                </div>
              </div>
